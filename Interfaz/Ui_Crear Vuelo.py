...
"font: 10pt \"Nirmala UI\"")
        ...
        self.lb_Capacidad.setGeometry(QRect(60, 130, 81, 31))
        ...
        self.spinBox_Capacidad.setGeometry(QRect(70, 170, 81, 31))
...
"}")
        ...
        self.bt_refreshTrip.setIcon(icon3)
...
"font: 75 12pt \"Nirmala UI\";")
        ...
        self.tb_vistaGeneralED.setStyleSheet(u"color : rgb(0,0,0);\n"
"font: 9 pt \"Open Sans\"")
...
"}")
        ...
        self.bt_buscarVuelo.setIcon(icon4)
...
"}")
        icon5 = QIcon()
        icon5.addFile(u"../Ventanas/Icons/borrarVuelo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_eliminarUNVuelo.setIcon(icon5)
...
"}")
        ...
        self.bt_addVuelo.setIcon(icon6)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u"../Ventanas/Icons/delete.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_eliminarVuelo.setIcon(icon7)
...
"}")
        icon8 = QIcon()
        icon8.addFile(u"../Ventanas/Icons/piloto.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_nuevoPiloto.setIcon(icon8)
    ...
    def retranslateUi(self, CrearVuelo):
        ...
        ___qtablewidgetitem15.setText(QCoreApplication.translate("CrearVuelo", u"Piloto", None));
        ___qtablewidgetitem16 = self.tb_vistaGeneralED.horizontalHeaderItem(10)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("CrearVuelo", u"Copiloto", None));
#if QT_CONFIG(tooltip)
