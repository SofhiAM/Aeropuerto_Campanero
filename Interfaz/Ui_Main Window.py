...
"}")
        ...
        self.tb_hangares.setHorizontalHeaderItem(0, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        __qtablewidgetitem16.setFont(font6);
        __qtablewidgetitem16.setForeground(brush);
        self.tb_hangares.setHorizontalHeaderItem(1, __qtablewidgetitem16)
        ...
        self.tb_hangares.setFont(font11)
        ...
        self.lb_HoraEntrada.setFont(font16)
        ...
        font17.setBold(True)
        font17.setWeight(75)
        self.bt_aceptarinfhg.setFont(font17)
...
"}")
        ...
        self.bt_ocuparHangar_2 = QPushButton(self.pg_hangares)
        self.bt_ocuparHangar_2.setObjectName(u"bt_ocuparHangar_2")
        self.bt_ocuparHangar_2.setGeometry(QRect(250, 400, 161, 41))
        self.bt_ocuparHangar_2.setFont(font5)
        self.bt_ocuparHangar_2.setCursor(QCursor(Qt.PointingHandCursor))
        self.bt_ocuparHangar_2.setStyleSheet(u"QPushButton:hover\n"
"{\n"
"	border-style: solid;\n"
"   	background-color:#bbdefb;\n"
"\n"
...
"}")
        icon16 = QIcon()
        icon16.addFile(u"../Ventanas/Icons/Facturaci\u00f3n.png", QSize(), QIcon.Normal, QIcon.Off)
        self.bt_ocuparHangar_2.setIcon(icon16)
        self.bt_ocuparHangar_2.setIconSize(QSize(40, 50))
        self.bt_ocuparHangar_2.setFlat(True)
    ...
    def retranslateUi(self, mainWindow):
        ...
        ___qtablewidgetitem15 = self.tb_hangares.horizontalHeaderItem(0)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("mainWindow", u"C\u00f3digo", None));
        ___qtablewidgetitem16 = self.tb_hangares.horizontalHeaderItem(1)
        ...
        self.bt_ocuparHangar_2.setText(QCoreApplication.translate("mainWindow", u"Generar Reporte", None))
    # retranslateUi
